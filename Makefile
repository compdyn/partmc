...
FFLAGS = -O -fimplicit-none -W -Wall -Wunused-labels -Wconversion -Wunderflow -Wimplicit-interface -Wno-unused -fbounds-check
LDFLAGS = 

F77 = gfortran

PROGS = process_out process_state run_golovin_adapt run_golovin_exact run_golovin_fix run_golovin_var run_sedi_adapt run_sedi_fix run_sedi_fix_hybrid run_sedi_fix_split run_sedi_fix_super run_sedi_ode run_sedi_sect run_sedi_var condensation_plot
...
# temporary hack
FREEFORM = condensation constants environ material process_state

process_state.o: bin.o environ.o material.o array_hybrid.o util.o constants.o array.o
...
process_state: process_state.o bin.o environ.o material.o array_hybrid.o util.o constants.o array.o
	$(F77) $(LDFLAGS) -o $@ process_state.o bin.o environ.o material.o array_hybrid.o util.o constants.o array.o
