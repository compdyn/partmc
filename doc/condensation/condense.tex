...
Given:
\begin{enumerate}
\item $q_{\rm back}(t_k)$: specific humidity of background air
  (outside cloud) at times $t_k$. For now we assume that the
  background is subsaturated, so most of the background water is in
  the vapor phase (liquid water content of subsaturated aerosols is
  very small).
...
First step is to determine the entrainment rate $\lambda_{\rm entrain}$.
\begin{itemize}
\item Change in total water mass (liquid and vapor) in the parcel due to entrainment:
\begin{equation}
\Delta m = \Delta_{\rm G}m -\Delta_{\rm L}m 
\end{equation}
\item Loss of liquid water mass from parcel to background: 
\begin{equation}
\Delta_{\rm L}m_{\rm l} = \lambda_{\rm entrain} \Delta t m_{\rm l}
\end{equation}
\item Loss of water vapor mass from parcel to background:
\begin{equation}
\Delta_{\rm L}m_{\rm w} = \lambda_{\rm entrain} \Delta t m_{\rm w}
\end{equation}
\item Loss of total water mass from parcel to background:
\begin{equation}
\Delta_{\rm L}m = \Delta_{\rm L}m_{\rm l} + \Delta_{\rm L}m_{\rm w}
\end{equation}
\item Gain in water vapor from background into parcel (at parcel conditions):
\begin{equation}
\Delta_{\rm G}m = \lambda_{\rm entrain} \Delta t V_{\rm comp} \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T)
\end{equation}
\item This gives:
\begin{align}
\Delta m &= \lambda_{\rm entrain} \left(\Delta t V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - \Delta t m_{\rm l} - \Delta t m_{\rm w} \right) \\
 \lambda_{\rm entrain} & = \frac{\Delta m }{\Delta t V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - \Delta t m_{\rm l} - \Delta t m_{\rm w}}
\end{align}
\item Divide numerator and denominator by $m_{air} = \rho_{\rm air} V_{\rm comp}$ (mass of air in parcel):
\begin{align}
 \lambda_{\rm entrain} & = \frac{\Delta m \cdot \frac{1}{m_{\rm air}}}{\Delta t \cdot \frac{1}{m_{\rm air}}\left(V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - \Delta t m_{\rm l} - \Delta t m_{\rm w}\right)} \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t \cdot \frac{1}{\rho_{\rm air}V_{\rm comp}}\left(V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - m_{\rm l} - m_{\rm w}\right)}  \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t\left(\frac{1}{\rho_{\rm air}}\frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - \left(\frac{m_{\rm l}}{V_{\rm comp}\rho_{\rm air}} + q_{\rm w} \right) \right)} \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t\left(\frac{\rho_{\rm v, back}}{\rho_{\rm air}} - \left(\frac{\rho_{\rm l}}{\rho_{\rm air}} + q_{\rm w} \right) \right)} \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t \left(q_{\rm back} - q_{\rm l} - q_{\rm w} \right)}
\end{align}
...
The entrainment rate $\lambda_{\rm entrain}$ is given by:
\begin{equation}
\lambda_{{\rm entrain}, k} = \frac{q_{{\rm tot}, k+1} - q_{{\rm tot}, k}}{(t_{k+1} - t_{k})(q_{{\rm back}, k} - q_{{\rm l}, k} - q_{{\rm v}, k})}.
\end{equation}

Using $\lambda_{\rm entrain}$ we do dilution of gases and dilution of
particles. Dilution of particles from the parcel into the background
will lead to change of liquid water content of the parcel, so $q_{{\rm
    l}, k}$ needs to be updated to $q_{{\rm l, new}, k}$. Dilution of
particles from the background means that the aerosol population in the
parcel changes.

The updated value $q_{{\rm l, new}, k}$ is then used to update the
parcel relative humidity, so that the prescribed $q_{{\rm tot}, k}$ is
matched.
\begin{align}
q_{{\rm v, new}, k} &= q_{{\rm tot}, k} - q_{{\rm l, new}, k} \\
p_{{\rm v, new}, k} &= \frac{q_{{\rm v, new}, k} p_k}
        {\epsilon + q_{{\rm v, new}, k} (1 - \epsilon)} \\
H_{{\rm new}, k} &= \frac{p_{{\rm v, new}, k}}{P^0(T_k)}
\end{align}
