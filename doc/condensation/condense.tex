...
\item $q_{\rm back}(t_k)$: specific humidity of background air
  (outside cloud) at times $t_k$. The background is subsaturated, so
  most of the background water is in the vapor phase (liquid water
  content of subsaturated aerosols is very small).
