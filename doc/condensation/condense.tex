...
\end{document}
 ...
 \left(m_{\rm l, back} + V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) -  m_{\rm l} - m_{\rm w} \right) \\
 \lambda_{\rm entrain} & = \frac{\Delta m }{\Delta t \left(m_{\rm l, back} + V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - m_{\rm l} - m_{\rm w}\right)}
\end{align}
\item Divide numerator and denominator by $m_{air} = \rho_{\rm air} V_{\rm comp}$ (mass of air in parcel):
\begin{align}
 \lambda_{\rm entrain} & = \frac{\Delta m \cdot \frac{1}{m_{\rm air}}}{\Delta t \cdot \frac{1}{m_{\rm air}}\left(m_{\rm l, back}+V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - \Delta t m_{\rm l} - \Delta t m_{\rm w}\right)} \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t \cdot \frac{1}{\rho_{\rm air}V_{\rm comp}}\left(m_{\rm l, back} + V_{\rm comp}  \frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - m_{\rm l} - m_{\rm w}\right)}  \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t\left(q_{\rm l, back} + \frac{1}{\rho_{\rm air}}\frac{1}{4}\rho_{\rm w} H_{\rm back} V(T) - \left(q{\rm l} + q_{\rm w} \right) \right)} \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t\left(q_{\rm l, back} + \frac{\rho_{\rm v, back}}{\rho_{\rm air}} - \left(q_{\rm l} + q_{\rm w} \right) \right)} \\
 \lambda_{\rm entrain} & = \frac{\Delta q}{\Delta t \left(q_{\rm l, back} + q_{\rm back} - q_{\rm l} - q_{\rm w} \right)}
\end{align}
