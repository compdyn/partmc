...
\begin{align}
  ...
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \dot{H}_i(D_i,H) &= - \frac{4}{\rho_{\rm w} V(T) V_{\rm comp}(T)} \dot{m}_i(D_i,H) \displaybreak[0] \\
  \frac{\partial \dot{H}_i}{\partial D_i}(D_i,H) &= - \frac{4}{\rho_{\rm w} V(T) V_{\rm comp}(T)} \frac{\partial \dot{m}_i}{\partial D_i}(D_i,H) \displaybreak[0] \\
  \frac{\partial \dot{H}_i}{\partial H}(D_i,H) &= - \frac{4}{\rho_{\rm w} V(T) V_{\rm comp}(T)} \frac{\partial \dot{m}_i}{\partial H}(D_i,H)
\end{align}
...
\begin{align}
  ...
  \frac{\partial \delta_i^*}{\partial H}(D_i, H) \displaybreak[0] \\
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \dot{m}_i(D_i,H) &= \rho_{\rm w} \frac{\pi}{2} D_{i,\rm dry}^2 \dot{D}_i(D_i,H) \displaybreak[0] \\
  \frac{\partial \dot{m}_i}{\partial D_i}(D_i,H) &= \rho_{\rm w} \frac{\pi}{2} D_{i,\rm dry}^2 \frac{\partial \dot{D}_i}{\partial D_i}(D_i,H) \displaybreak[0] \\
  \frac{\partial \dot{m}_i}{\partial H}(D_i,H) &= \rho_{\rm w} \frac{\pi}{2} D_{i,\rm dry}^2 \frac{\partial \dot{D}_i}{\partial H}(D_i,H)
\end{align}
