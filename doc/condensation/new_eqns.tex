...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \frac{\partial a_{{\rm w}i}}{\partial D_i}(D_i) &= \frac{3 D_i^2 \kappa_i D_{i,\rm dry}}{(D_i^3 + (\kappa_i - 1) D_{i,\rm dry}^3)^2} \displaybreak[0] \\
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \dot{D_i}(D_i, H) &= \frac{k_{\rm a}'(D_i) \delta_i^*(D_i,H)}{U D_i} \label{eq:delta_star} \displaybreak[0] \\
 ...
 \dot{H_i}(D_i,H) &= - \frac{2 \pi}{V V_{\rm comp}} D_i^2 \dot{D_i}(D_i,H) \displaybreak[0] \\
  \dot{H}(D_i,\ldots,D_N,H) &= - \frac{2 \pi}{V V_{\rm comp}} \sum_i D_i^2 \dot{D_i}(D_i,H) \displaybreak[0] \\
 ...
 \frac{\partial \dot{H_i}}{\partial H}(D_i,H) &=
  - \frac{2 \pi}{V V_{\rm comp}} D_i^2
  \frac{\partial \dot{D_i}}{\partial H}(D_i,H) \\
