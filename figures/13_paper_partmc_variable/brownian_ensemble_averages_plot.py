...
f1 = "data/ensemble_norm_num_brownian.txt" 
f2 = "data/ensemble_norm_mass_brownian.txt" 
...
small_time_step = axes.plot(num_avg_overall_6s, 'r-')
axes.set_xscale("log")
axes.set_yscale("log")
...
small_time_step = axes.plot(mass_avg_overall_6s, 'r-')
axes.set_xscale("log")
axes.set_yscale("log")
