...
netcdf_dir = "/Users/nriemer/subversion/partmc/trunk/local_scenarios/brownian_test_paper/out_600s/out/"
...
for i_ens in range (0, i_ens_max):
    for i_loop in range (0, i_loop_max):
        ...
        netcdf_pattern = "brownian_part_0%03d_(.*).nc"  % (i_loop+1 + i_ens*100)
    ...
    f1 = "data/ensemble_norm_num_brownian_%02d_600s.txt" % (i_ens + 1)
    f2 = "data/ensemble_norm_mass_brownian_%02d_600s.txt" % (i_ens + 1)
