...
time_step_60s_high = axes.plot(x_array, num_avg_overall_60s+conf_factor*num_std_overall_60s,  'b.', markersize=0.2)
time_step_60s_low = axes.plot(x_array, num_avg_overall_60s-conf_factor*num_std_overall_60s,  'b.', markersize=0.2)
time_step_600s = axes.plot(x_array, num_avg_overall_600s, 'r-')
time_step_600s_high = axes.plot(x_array, num_avg_overall_600s+conf_factor*num_std_overall_600s,  'r.', markersize=0.2)
time_step_600s_low = axes.plot(x_array, num_avg_overall_600s-conf_factor*num_std_overall_600s,  'r.', markersize=0.2)
time_step_1200s = axes.plot(x_array, num_avg_overall_1200s, 'm-')
time_step_1200s_high = axes.plot(x_array, num_avg_overall_1200s+conf_factor*num_std_overall_1200s,  'm.', markersize=0.2)
time_step_1200s_low = axes.plot(x_array, num_avg_overall_1200s-conf_factor*num_std_overall_1200s,  'm.', markersize=0.2)
axes.set_xscale("log")
axes.set_yscale("log")
...
time_step_6s = axes.errorbar(x_array, mass_avg_overall_6s, conf_factor*mass_std_overall_6s, fmt = 'g-')
time_step_60s = axes.errorbar(x_array, mass_avg_overall_60s, conf_factor*mass_std_overall_60s, fmt = 'b-')
time_step_600s = axes.errorbar(x_array, mass_avg_overall_600s, conf_factor*mass_std_overall_600s, fmt = 'r-')
time_step_1200s = axes.errorbar(x_array, mass_avg_overall_1200s, conf_factor*mass_std_overall_1200s, fmt = 'm-')
axes.set_xscale("log")
axes.set_yscale("log")
