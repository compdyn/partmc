...
num_avg1 = np.loadtxt("data/2d_bc_10K_wei+1_12_hist_array_average_num.txt") / 1e6
num_avg2 = np.loadtxt("data/2d_bc_10K_wei-1_12_hist_array_average_num.txt") / 1e6
num_avg3 = np.loadtxt("data/2d_bd_10K_wei-4_12_hist_array_average_num.txt") / 1e6

mass_avg1 = np.loadtxt("data/2d_bc_10K_wei+1_12_hist_array_average_mass.txt") * 1e9
mass_avg2 = np.loadtxt("data/2d_bc_10K_wei-1_12_hist_array_average_mass.txt") * 1e9
mass_avg3 = np.loadtxt("data/2d_bc_10K_wei-4_12_hist_array_average_mass.txt") * 1e9
