...
901      read(*,*,end=902) Dd_micron, k
	  Dd = Dd_micron * 1.e-4	! cm
        call critical_supersat(Dd, k, A, Sca, Scn, iter, Dc)
        write(*,*) Dd, Dc, k, Sca, Scn, iter
        goto 901
...
!------------------------------------------------------------------------------------------
      subroutine critical_supersat(Dd, k, A, Sca, Scn, iter, Dc)
      implicit none
