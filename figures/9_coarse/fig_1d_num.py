...
#    dry_diameter3 = particles3.dry_diameter()
    ...
    hist1 = pmc_data_nc.histogram_1d(dry_diameter1, x_axis, weights = 1 / particles1.comp_vol)
#    hist2 = pmc_data_nc.histogram_1d(dry_diameter2, x_axis, weights = 1 / particles2.comp_vol)
#    hist3 = pmc_data_nc.histogram_1d(dry_diameter3, x_axis, weights = 1 / particles3.comp_vol)
...
#    filename_in3 = "urban_plume_wc_0003_000000%02d.nc" % hour
    filename_out = "figs/1d_wc_num_%02d_f-100K.pdf" % hour
