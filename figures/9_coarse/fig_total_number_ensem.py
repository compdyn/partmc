...
plt.xlabel("ensemble size ")
plt.ylabel("average std/avg number concentration")
plt.legend(loc = 'lower right')
fig = plt.gcf()
...
plt.xlabel("ensemble size ")
plt.ylabel("average std/avg mass concentration")
plt.legend(loc = 'lower right')
fig = plt.gcf()
...
plt.clf()
plt.plot(x_array[1:], num_avg_overall[6,1:], 'c', label = '1K wei+1')
plt.plot(x_array[1:], num_avg_overall[7,1:], 'b', label = '1K flat')
plt.plot(x_array[1:], num_avg_overall[8,1:], 'g', label = '1K wei-1')
plt.plot(x_array[1:], num_avg_overall[9,1:], 'r', label = '1K wei-2')
plt.plot(x_array[1:], num_avg_overall[10,1:], 'k', label = '1K wei-3')
plt.plot(x_array[1:], num_avg_overall[11,1:], 'm', label = '1K wei-4')
plt.xlabel("ensemble size ")
plt.ylabel("average number concentration in m^{-3}")
plt.legend(loc = 'lower right')
fig = plt.gcf()
...
plt.clf()
plt.plot(x_array[3:], num_std_overall[6,3:]/num_avg_overall[6,3:], 'c', label = '1K wei+1')
plt.plot(x_array[3:], num_std_overall[7,3:]/num_avg_overall[7,3:], 'b', label = '1K flat')
plt.plot(x_array[3:], num_std_overall[8,3:]/num_avg_overall[8,3:], 'g', label = '1K wei-1')
plt.plot(x_array[3:], num_std_overall[9,3:]/num_avg_overall[9,3:], 'r', label = '1K wei-2')
plt.plot(x_array[3:], num_std_overall[10,3:]/num_avg_overall[10,3:], 'k', label = '1K wei-3')
plt.plot(x_array[3:], num_std_overall[11,3:]/num_avg_overall[11,3:], 'm', label = '1K wei-4')
plt.xlabel("ensemble size ")
plt.ylabel("average std/avg number concentration")
plt.legend(loc = 'lower right')
fig = plt.gcf()
...
plt.clf()
plt.plot(x_array[1:], mass_avg_overall[6,1:], 'c', label = '1K wei+1')
plt.plot(x_array[1:], mass_avg_overall[7,1:], 'b', label = '1K flat')
plt.plot(x_array[1:], mass_avg_overall[8,1:], 'g', label = '1K wei-1')
plt.plot(x_array[1:], mass_avg_overall[9,1:], 'r', label = '1K wei-2')
plt.plot(x_array[1:], mass_avg_overall[10,1:], 'k', label = '1K wei-3')
plt.plot(x_array[1:], mass_avg_overall[11,1:], 'm', label = '1K wei-4')
plt.xlabel("ensemble size ")
plt.ylabel("average mass concentration in \mu g m^{-3}")
plt.legend(loc = 'lower right')
fig = plt.gcf()
...
plt.clf()
plt.plot(x_array[3:], mass_std_overall[6,3:]/mass_avg_overall[6,3:], 'c', label = '1K wei+1')
plt.plot(x_array[3:], mass_std_overall[7,3:]/mass_avg_overall[7,3:], 'b', label = '1K flat')
plt.plot(x_array[3:], mass_std_overall[8,3:]/mass_avg_overall[8,3:], 'g', label = '1K wei-1')
plt.plot(x_array[3:], mass_std_overall[9,3:]/mass_avg_overall[9,3:], 'r', label = '1K wei-2')
plt.plot(x_array[3:], mass_std_overall[10,3:]/mass_avg_overall[10,3:], 'k', label = '1K wei-3')
plt.plot(x_array[3:], mass_std_overall[11,3:]/mass_avg_overall[11,3:], 'm', label = '1K wei-4')
plt.xlabel("ensemble size ")
plt.ylabel("average std/avg mass concentration")
plt.legend(loc = 'lower right')
fig = plt.gcf()
