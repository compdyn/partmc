...
output_prefix out_both/cond_1        # prefix of output files
n_loop 1                        # number of Monte Carlo loops
n_part 1                        # total number of particles
kernel brown                    # coagulation kernel
restart yes                     # whether to restart from saved state (yes/no)
restart_file start_both/urban_plume_wc_0001_00000002.nc # saved state file to restart from
...
temp_profile temp_1.dat         # temperature profile file
