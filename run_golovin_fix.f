...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      integer MM, n_bin, n_spec, n_loop, scal
      ...
      do i_loop = 1,n_loop
         ...
         call make_grid(n_bin, n_spec, scal, rho_p, bin_v, bin_r, dlnr)
         call init_exp(MM, V_0, dlnr, n_bin, n_spec, bin_v, bin_r, n_ini)
         call compute_volumes(n_bin, n_spec, MM, n_ini, bin_r, dlnr, V, M)
         V_comp = M / N_0

         call mc_fix(MM, M, V, V_comp, 
     &        n_bin, n_spec, bin_v, bin_r, bin_g, bin_n, dlnr,
