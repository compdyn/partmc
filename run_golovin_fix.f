...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
      ...
      parameter (V_02 = 2*V_01)    ! mean volume of #2-initial distribution
...
cn *** initialise first distribution
         ...
         call compute_volumes(n_bin, n_spec, n_spec_in, MM_1, 1,MM_1,
     $        n_ini,bin_r, dlnr, V, M1)

cn *** initialise second distribution
         call init_exp(MM-MM_1, V_02, dlnr, n_bin, bin_v, bin_r, n_ini)
         call compute_volumes(n_bin, n_spec, n_spec_in, MM-MM_1, MM_1+1,
