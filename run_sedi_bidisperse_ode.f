...
C     the current number of small particles.
      ...
      real*8 v_small, v_big_init, n_small_init, del_t, t_max
      ...
      parameter (del_t = 0.01d0)              ! timestep
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
     ...
     &     v_small, v_big_init, n_small_init, n_small_dot)
