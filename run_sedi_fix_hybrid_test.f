...
program run_sedi_fix_hybrid_test
...
! Test case for comparison with run_sedi_sect. Only one species.
 
  integer, parameter :: MM = 10000000   ! number of particles
...
end program run_sedi_fix_hybrid_test
