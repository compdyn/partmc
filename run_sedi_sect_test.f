...
program run_sedi_sect_test
  ...
  call make_bin_grid(n, scal, v_min, bin_v, dlnr)
  do i = 1,n
  ...
  do i = 1,n
     ...
     if (g(i) .le. 1d-80) g(i) = 0d0    ! this is to fix problem with gnuplot. 
  enddo
...
end program run_sedi_sect_test
