...
axes.annotate(r"\rotatebox{30}{$\gamma=0$}", (x_values[1], 1),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')
...
end = len(avg_part_entropy1)

axes.plot(avg_part_entropy1[1:end]/np.log(10), entropy_of_avg_part1[1:end]/np.log(10), "b-", linewidth=1.5)
axes.annotate("",
            xy=(avg_part_entropy1[24]/np.log(10),entropy_of_avg_part1[24]/np.log(10)), xycoords='data',
            xytext=(avg_part_entropy1[22]/np.log(10),entropy_of_avg_part1[22]/np.log(10)), textcoords='data',
            arrowprops=dict(arrowstyle="simple, head_width=1, head_length=2, tail_width=0.001",
                            connectionstyle="arc3", ec ="b", fc = "b", ),
            )

x_values = np.linspace(0,2,21)
axes.plot(x_values, x_values/0.6, "k", linewidth=0.5)
axes.plot(x_values, x_values/0.7, "k", linewidth=0.5)
axes.plot(x_values, x_values/0.8, "k", linewidth=0.5)
axes.plot(x_values, x_values/0.9, "k", linewidth=0.5)
axes.plot(x_values, x_values, "k", linewidth=0.5)

axes.annotate(r"$\gamma=0.6$", (0.55, 0.55/0.6),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')

axes.annotate(r"$\gamma=0.7$", (0.645, 0.645/0.7),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')

axes.annotate(r"$\gamma=0.8$", (0.74, 0.74/0.8),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')

axes.annotate(r"$\gamma=0.9$", (0.77, 0.77/0.9),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')

axes.annotate(r"$\gamma=1$", (0.77, 0.77),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')
...
axes.set_xticks([0.5, 0.6, 0.7, 0.8])
axes.set_ylim([0.65,0.95])
axes.set_yticks([0.7,0.8, 0.9])
#axes.set_yticks([0, 0.2, 0.4, 0.6, 0.8, 1])
axes.set_ylabel(r"$\bar{\hat{H}}/\ln(A)$")
#pts = np.array([[0,0], [1,1], [0,1]])
#p = Polygon(pts,closed=True,alpha=0.05)
...
axes.grid(True)
figure.savefig("h_hat_versus_h_bar_urban_plume.pdf")



(figure, axes) = mpl_helper.make_fig(figure_width=5, axis_ratio=1)
ncf = scipy.io.netcdf_file("urban_plume/out/urban_plume2_process_bc.nc")
avg_part_entropy1 = ncf.variables["avg_part_entropy"].data
entropy_of_avg_part1 = ncf.variables["entropy_of_avg_part"].data
ncf.close()

axes.plot(avg_part_entropy1/np.log(10), entropy_of_avg_part1/np.log(10), "b-", linewidth=2)
axes.annotate("",
            xy=(avg_part_entropy1[16]/np.log(10),entropy_of_avg_part1[16]/np.log(10)), xycoords='data',
            xytext=(avg_part_entropy7[6]/1.4,entropy_of_avg_part7[6]/1.4), textcoords='data',
            arrowprops=dict(arrowstyle="simple, head_width=0.5, head_length=1, tail_width=0.001",
                            connectionstyle="arc3", ec ="g", fc = "g", ),
            )
...
axes.grid(True)
figure.savefig("h_hat_versus_h_bar_urban_plume_bc.pdf")
