...
axes.grid(True)
axes.text(-0.45, 0.5, r'Case 4', horizontalalignment='center',
...
axes.grid(True)
axes.text(-0.45, 0.5, r'Case 3', horizontalalignment='center',
           verticalalignment='center', transform=axes.transAxes,
           rotation='vertical', bbox=dict(edgecolor='black', facecolor='white',
                                          boxstyle="round,pad=0.5"))
...
axes.grid(True)
axes.text(-0.45, 0.5, r'Case 2', horizontalalignment='center',
           verticalalignment='center', transform=axes.transAxes,
           rotation='vertical', bbox=dict(edgecolor='black', facecolor='white',
                                          boxstyle="round,pad=0.5"))
...
axes.grid(True)
axes.text(-0.45, 0.5, r'Case 1', horizontalalignment='center',
           verticalalignment='center', transform=axes.transAxes,
           rotation='vertical', bbox=dict(edgecolor='black', facecolor='white',
                                          boxstyle="round,pad=0.5"))
