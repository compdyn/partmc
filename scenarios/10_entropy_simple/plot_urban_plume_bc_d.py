...
######## first row ###############
filename = 'urban_plume/out/urban_plume2_process_bc_new.nc'
...
axes2.set_ylim([40,90])
axes2.set_xlim([0,48])
axes2.set_xticks([0, 12, 24, 36, 48])

axes.annotate(r"$D_{\gamma}$", (5.9,7.55),
              verticalalignment="bottom", horizontalalignment="right",
              #bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')
axes.annotate(r"$D_{\alpha}$", (36,3.5),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')
axes.annotate(r"$\chi$", (36,8),
              verticalalignment="bottom", horizontalalignment="right",
              bbox = dict(facecolor='white', edgecolor='white'),
              xytext=(0, 5), textcoords='offset points')
...
out_filename = "urban_plume_bc_d_new.pdf"
