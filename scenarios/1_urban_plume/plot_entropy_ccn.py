...
ncf2 = scipy.io.netcdf_file("out/urban_plume_comp1_process.nc")
...
axes.plot(avg_entropy1, (ccn01_2-ccn01_1)/ccn01_1, "bo")
axes.plot(avg_entropy1, (ccn03_2-ccn03_1)/ccn03_1, "go")
axes.plot(avg_entropy1, (ccn06_2-ccn06_1)/ccn06_1, "ro")
axes.set_xlabel(r"entropy")
axes.set_ylabel(r"rel. CCN conc. diff. / 1 ")
axes.grid(True)

figure.savefig("out/urban_plume_entropy_ccn_diff1.pdf")
