...
plot "out/urban_plume2_wc_aero_particle_mass_00000001.txt" using ($3*1e6):(($23/($4-$24))*100) with points notitle
set title "BC composition (with coag) at 5 hours"
plot "out/urban_plume2_wc_aero_particle_mass_00000006.txt" using ($3*1e6):(($23/($4-$24))*100) with points notitle
set title "BC composition (with coag) at 7 hours"
plot "out/urban_plume2_wc_aero_particle_mass_00000008.txt" using ($3*1e6):(($23/($4-$24))*100) with points notitle
set title "BC composition (with coag) at 24 hours"
plot "out/urban_plume2_wc_aero_particle_mass_00000025.txt" using ($3*1e6):(($23/($4-$24))*100) with points notitle
