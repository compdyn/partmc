...
plot "out/urban_plume2_wc_aero_species.txt" using ($1/3600):($3*1e9) axes x1y1 with lines title "NO3", \
     "out/urban_plume2_wc_aero_species.txt" using ($1/3600):($19*1e9) axes x1y1 with lines title "OC", \
     "out/urban_plume2_wc_aero_species.txt" using ($1/3600):($5*1e9) axes x1y1 with lines title "NH4"
