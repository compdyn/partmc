...
plot "out/ogo_test_0001_aero_time.txt" using ($1/3600):2 axes x1y1 with lines title "number concentration", \
     "out/ogo_test_0001_aero_time.txt" using ($1/3600):3 axes x1y2 with lines title "mass concentration"
