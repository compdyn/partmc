...
#Mixing experiment
data  = pd.read_csv('exp_data/exp_suc2as_2.txt',sep='\s+|,', skiprows=19, nrows=102, header=None, engine = 'python')
new_data = data.T
...
#Premixing AS
data_as  = pd.read_csv('exp_data/exp_suc2as_aspre.txt',sep='\s+|,', skiprows=19, nrows=102, header=None, engine = 'python')
...
#Premixing Suc
data_suc  = pd.read_csv('exp_data/exp_suc2as_sucpre.txt',sep='\s+|,', skiprows=19, nrows=102, header=None, engine = 'python')
...
axes.plot(diam, dist[41,:], label="Exp Time:" + new_data.iloc[40+2,0])
axes.plot(diam, dist[42,:], label="Exp Time:" + new_data.iloc[41+2,0])
axes.plot(diam, dist[43,:], label="Exp Time:" + new_data.iloc[42+2,0])
...
#axes.plot(diam_pmc, num_dist_plot[:,5], label="50 min")
axes.plot(diam_pmc, num_dist_plot[:,6], label="pmc 60 min")
axes.plot(diam_pmc, num_dist_plot[:,7], label="pmc 70 min")
...
axes.grid(True)
axes.legend()
out_filename = "out_pfr_suc2as_2/urban_plume_num_dist.pdf"
