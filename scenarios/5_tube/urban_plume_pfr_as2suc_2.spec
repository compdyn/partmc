...
t_max 4000                      # total simulation time (s)
del_t 60                        # timestep (s)
...
aerosol_init aero_init_dist_pfr_as2suc_2.dat # aerosol initial condition file
...
aero_background aero_back_pfr_as2suc_2.dat   # aerosol background file
