...
t_max 4800                      # total simulation time (s)
del_t 60                        # timestep (s)
...
aerosol_init aero_init_dist_pfr_suc2as_1.dat # aerosol initial condition file
...
aero_background aero_back_pfr_suc2as_1.dat   # aerosol background file
loss_function none              # loss function specification

rel_humidity 0.10               # initial relative humidity (1)
