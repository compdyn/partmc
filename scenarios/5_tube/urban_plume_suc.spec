...
t_max 21600                     # total simulation time (s)
del_t 60                        # timestep (s)
...
aerosol_init aero_init_dist_suc.dat # aerosol initial condition file
...
aero_background aero_back_suc2as.dat   # aerosol background file
