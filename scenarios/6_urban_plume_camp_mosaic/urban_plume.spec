...
output_prefix mosaic/urban_plume   # prefix of output files
...
gas_init gas_init_mosaic.dat           # initial gas concentrations

aerosol_data aero_data.dat      # file containing aerosol data
do_fractal no                   # whether to do fractal treatment
aerosol_init aero_init_dist_mosaic.dat # aerosol initial condition file

temp_profile temp.dat           # temperature profile file
pressure_profile pres.dat       # pressure profile file
height_profile height.dat       # height profile file
gas_emissions gas_emit_mosaic.dat      # gas emissions file
gas_background gas_back_mosaic.dat     # background gas concentrations file
aero_emissions aero_emit_mosaic.dat    # aerosol emissions file
aero_background aero_back_mosaic.dat   # aerosol background file
