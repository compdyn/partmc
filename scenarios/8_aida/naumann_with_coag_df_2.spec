...
output_prefix out_naumann_df_2/aida_wc # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 100000                     # total number of particles
restart no                      # whether to restart from saved state (yes/no)

t_max 95760                     # total simulation time (s)
del_t 60                       # timestep (s)
...
aerosol_init aero_init_dist_sampled_naumann.dat # aerosol initial condition file
...
aero_background aero_back_noDilution.dat   # aerosol background file
...
prime_radius 13.5e-9             # radius of monomer
