...
plot "out/condense_0001_gas.txt" using ($1):12 axes x1y1 with lines title "O3", \
     "out/condense_0001_gas.txt" using ($1):7 axes x1y1 with lines title "NO2"

plot "out/condense_0001_gas.txt" using ($1):3 axes x1y1 with lines title "HNO3", \
     "out/condense_0001_gas.txt" using ($1):24 axes x1y1 with lines title "HCHO", \
     "out/condense_0001_gas.txt" using ($1):19 axes x1y1 with lines title "SO2", \
     "out/condense_0001_gas.txt" using ($1):5 axes x1y1 with lines title "NH3"
