...
output_prefix out/urban_plume_aq_chem_c   # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart yes                     # whether to restart from saved state (yes/no)
restart_file out/urban_plume_aq_chem_0001_00000061.nc
...
pressure_profile pres_3.dat     # pressure profile file
height_profile height_3.dat     # height profile file
gas_emissions gas_emit_3.dat    # gas emissions file
gas_background gas_back_3.dat   # background gas concentrations file
aero_emissions aero_emit_3.dat  # aerosol emissions file
aero_background aero_back_3.dat # aerosol background file
