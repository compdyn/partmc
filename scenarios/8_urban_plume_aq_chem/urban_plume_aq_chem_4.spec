...
output_prefix out/urban_plume_aq_chem_d   # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart yes                     # whether to restart from saved state (yes/no)
restart_file out/urban_plume_aq_chem_0001_00000121.nc

t_max 3000                      # total simulation time (s)
del_t 1                         # timestep (s)
t_output 60                     # output interval (0 disables) (s)
t_progress 600                  # progress printing interval (0 disables) (s)

temp_profile temp_4.dat         # temperature profile file
pressure_profile pres_4.dat     # pressure profile file
height_profile height_4.dat     # height profile file
gas_emissions gas_emit_4.dat    # gas emissions file
gas_background gas_back_4.dat   # background gas concentrations file
aero_emissions aero_emit_4.dat  # aerosol emissions file
aero_background aero_back_4.dat # aerosol background file
