...
t_max %%t_max%%  #20160 #15960 #19740 #65100 #16200 #14400 #15600                     # total simulation time (s)
del_t 60                       # timestep (s)
t_output %%t_output%%   #420 #600                   # output interval (0 disables) (s)
...
temp_profile %%temp_profile%%   #temp.dat           # temperature profile file
...
aero_background %%aero_background%%  #aero_back.dat   # aerosol background file

rel_humidity %%rel_humidity%%  #0.0986 #0.1275 #0.0945 #0.0482 #0.0385             # initial relative humidity (1)
...
frac_dim %%frac_dim%%                   # fractal dimension
prime_radius %%prime_radius%%             # radius of monomer
vol_fill_factor %%vol_fill_factor%%            # volume filling factor
