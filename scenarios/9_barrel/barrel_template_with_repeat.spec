...
t_max %%t_max%%                # total simulation time (s)
del_t 60                       # timestep (s)
...
aerosol_init %%aero_init_dist_sampled%% # aerosol initial condition file
...
rel_humidity %%rel_humidity%%  # initial relative humidity (1)
