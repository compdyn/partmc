...
output_prefix out_as_0_3LPM_coag_dil_wall/barrel_wc # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 100000                     # total number of particles
restart no                      # whether to restart from saved state (yes/no)

t_max 14400 #15600                     # total simulation time (s)
del_t 60                       # timestep (s)
...
rel_humidity 0.0482 #0.0385             # initial relative humidity (1)
