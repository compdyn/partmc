...
output_prefix out_aerodyne_0716/barrel_wc # prefix of output files
...
aerosol_init aero_init_dist_sampled_aerodyne_0716.dat # aerosol initial condition file

temp_profile temp_aerodyne_0716.dat           # temperature profile file
...
aero_background aero_back_aerodyne_0716.dat   # aerosol background file

rel_humidity 0.1                # initial relative humidity (1)
latitude 0                      # latitude (degrees, -90 to 90)
longitude 0                     # longitude (degrees, -180 to 180)
altitude 0                      # altitude (m)
start_time 46400 #57660                # start time (s since 00:00 UTC)
start_day 197                    # start day of year (UTC)
