...
output_prefix out_aerodyne_0326/barrel_wc # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart no                      # whether to restart from saved state (yes/no)

t_max 68400                      # total simulation time (s)
del_t 60                        # timestep (s)
...
aerosol_init aero_init_dist_sampled_aerodyne_0326.dat # aerosol initial condition file

temp_profile temp_aerodyne_0326.dat           # temperature profile file
...
aero_background aero_back_aerodyne_0326.dat   # aerosol background file

rel_humidity 0.1                # initial relative humidity (1)
latitude 0                      # latitude (degrees, -90 to 90)
longitude 0                     # longitude (degrees, -180 to 180)
altitude 0                      # altitude (m)
start_time 54117 #57660                # start time (s since 00:00 UTC)
start_day 85                    # start day of year (UTC)
