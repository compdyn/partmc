...
output_prefix out_aerodyne_0830/barrel_wc # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart no                      # whether to restart from saved state (yes/no)

t_max 18600                      # total simulation time (s)
del_t 60                        # timestep (s)
...
aerosol_init aero_init_dist_sampled_aerodyne_0830.dat # aerosol initial condition file

temp_profile temp_aerodyne_0830.dat           # temperature profile file
...
aero_background aero_back_aerodyne_0830.dat   # aerosol background file
