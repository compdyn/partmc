...
partmc_num = np.loadtxt("out/f_1_wc_0001_aero_size_num.txt")
barrel_num = np.loadtxt("ref_aero_size_num_regrid.txt")
partmc_mass = np.loadtxt("out/f_1_wc_0001_aero_size_mass.txt")
...
for col in range(1,partmc_num.shape[1]):
    ...
    filename_out = "plots_aero_num_size/aero_num_size_time%02d_df_2_5_f_1.pdf" %(t)
...
if shape_opt == 's':
   ...
   for col in range(1,partmc_mass.shape[1]):
       ...
       filename_out = "plots_aero_mass_size/aero_mass_size_time%02d_df_2_5_f_1.pdf" %(t)
       figure.savefig(filename_out)
if shape_opt == 'f':
   t = 0
