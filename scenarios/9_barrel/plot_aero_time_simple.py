...
partmc_time = np.loadtxt("out_aerodyne_0830/barrel_wc_0001_aero_time.txt")
barrel_time = np.loadtxt("ref_aerodyne_0830/ref_aero_time.txt")
...
axes.grid()
#axes.set_yscale('log')
axes.legend(('Barrel', 'PartMC'), loc='best')
