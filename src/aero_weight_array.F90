...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  elemental subroutine aero_weight_array_allocate(aero_weight_array)

    !> Aerosol weight.
    type(aero_weight_array_t), intent(out) :: aero_weight_array

    aero_weight_array%n_weights = 0
    call aero_weight_allocate(aero_weight_array%aero_weight(0))

  end subroutine aero_weight_array_allocate

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!FIXME: What to do here?
  !> Allocates an aero_weight_array of the given size.
  elemental subroutine aero_weight_array_allocate_size(aero_weight_array)
...
!FIXME: What to do here?
  !> Free all storage.
  elemental subroutine aero_weight_array_deallocate(aero_weight_array)
    ...
    do i = 1, aero_weight_array%n_weights
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  elemental subroutine aero_weight_array_zero(aero_weight_array)
    ...
    do i = 1, aero_weight_array%n_weights
       call aero_weight_zero(aero_weight_array%aero_weight(i))
    end do
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  elemental subroutine aero_weight_array_zero_comp_vol(aero_weight_array)
    ...
    do i = 1,size(aero_weight_array%aero_weight)
       call aero_weight_zero_comp_vol(aero_weight_array%aero_weight(i))
    end do

  end subroutine aero_weight_array_zero_comp_vol

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! FIXME: Don't need this here?
  !> Copy an aero_weight.
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! FIXME: This lives in aero_weight.F90?
  !> Copy an aero_weight array.
  subroutine aero_weight_array_copy_new(aero_weight_array_from, &
...
!    call aero_weight_copy(aero_weight_array_from, aero_weight_array_to)
  ...
  end subroutine aero_weight_array_copy_new
...
! FIXME: Nothing needed like this?
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! FIXME: This function takes in an array already.  Also located in
! aero_weight.F90.
  !> Compute the number concentration for a particle (m^{-3}).
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! FIXME: This is in aero_weight.F90. Can be easily modified
