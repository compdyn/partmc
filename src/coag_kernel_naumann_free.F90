...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  end subroutine kernel_naumann_free_minmax
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine kernel_naumann_free_helper(v1, d1, v2, d2, aero_data, &
    ...
    real(kind=dp) :: rho, N_i, N_j, f, df, R0, N_i_inv_df, N_j_inv_df
    ...
    f = aero_data%fractal%vol_fill_factor
    ...
    bckernel = sqrt(6d0 * const%boltzmann * temp * R0 / rho &
         * (1d0 / N_i + 1d0 / N_j)) &
         * f**(2d0 / df) * (N_i_inv_df + N_j_inv_df)**2d0

  end subroutine kernel_naumann_free_helper

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

end module pmc_coag_kernel_naumann_free
