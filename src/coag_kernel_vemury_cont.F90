...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine kernel_vemury_cont(aero_particle_1, aero_particle_2, &
    ...
    call kernel_vemury_cont_helper(v1, d1, v2, d2, aero_data, &
         env_state%temp, k)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine kernel_vemury_cont_minmax(v1, v2, aero_data, env_state, &
       k_min, k_max)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !!
  !! Use Eq. 6 of Vemury and Pratsinis [1995].
  subroutine kernel_vemury_cont_helper(v1, d1, v2, d2, aero_data, &
       temp, bckernel)
