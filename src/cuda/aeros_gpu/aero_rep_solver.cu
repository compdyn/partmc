 ...
 */
int aero_rep_get_used_jac_elem(ModelDatagpu *model_data, int aero_rep_idx,
 ...
 *         representation data
 */
void *aero_rep_get_dependencies(ModelDatagpu *model_data, bool *state_flags) {
 ...
 */
void aero_rep_update_env_state(ModelDatagpu *model_data, double *env) {
 ...
 * \param model_data Pointer to the model data
 */
void aero_rep_update_state(ModelDatagpu *model_data) {
 ...
 */
void *aero_rep_get_effective_radius(ModelDatagpu *model_data, int aero_rep_idx,
 ...
 *         derivatives exist
 */
void *aero_rep_get_number_conc(ModelDatagpu *model_data, int aero_rep_idx,
 ...
 */
int aero_rep_get_aero_conc_type(ModelDatagpu *model_data, int aero_rep_idx,
                                int aero_phase_idx) {
 ...
 *         derivatives exist
 */
void *aero_rep_get_aero_phase_mass(ModelDatagpu *model_data, int aero_rep_idx,
