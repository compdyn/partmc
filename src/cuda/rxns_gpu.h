...
__device__ void rxn_gpu_aqueous_equilibrium_calc_deriv_contrib(
          ...
          double * double_pointer_gpu, double time_step, int deriv_length);
__device__ void rxn_gpu_aqueous_equilibrium_calc_jac_contrib(
          ModelDatagpu *model_data, realtype *J, void *rxn_data, double * double_pointer_gpu, double time_step, int deriv_length);
#endif
