 ...
 * \return The rxn_data pointer advanced by the size of the reaction data
 */
void * rxn_gpu_ZSR_aerosol_water_update_ids(ModelData *model_data, int *deriv_ids,
 ...
 * \return The rxn_data pointer advanced by the size of the reaction data
 */
void * rxn_gpu_ZSR_aerosol_water_pre_calc(ModelData *model_data, void *rxn_data)
{
  int n_rxn=1;
