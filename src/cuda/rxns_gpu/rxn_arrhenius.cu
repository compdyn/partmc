...
#include "../rxns_gpu.h"
  ...
  //TODO: add ifdef gpu on here for *n_rxn (or avoid it since is increasing only a bit the time)
...
__host__ __device__
#endif
/*void rxn_gpu_arrhenius_calc_deriv_contrib(double *rxn_env_data, double *state,
