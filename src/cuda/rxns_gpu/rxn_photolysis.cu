...
__device__ void rxn_gpu_photolysis_calc_deriv_contrib(ModelDatagpu *model_data,
 ...
 */
#ifdef PMC_USE_SUNDIALS
__device__ void rxn_gpu_photolysis_calc_jac_contrib(ModelDatagpu *model_data, double *J,
