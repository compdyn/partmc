 ...
 */
void * rxn_gpu_photolysis_get_used_jac_elem(void *rxn_data, bool **jac_struct)
{
  int n_rxn=1;
 ...
 * \return The rxn_data pointer advanced by the size of the reaction data
 */
void * rxn_gpu_photolysis_update_ids(ModelDatagpu *model_data, int *deriv_ids,
 ...
 * \return The rxn_data pointer advanced by the size of the reaction data
 */
void * rxn_gpu_photolysis_update_data(void *update_data, void *rxn_data)
{
  int n_rxn=1;
  int *int_data = (int*) rxn_data;
  double *float_data = (double*) &(int_data[INT_DATA_SIZE_]);
 ...
 * \return The rxn_data pointer advanced by the size of the reaction data
 */
__device__ void rxn_gpu_photolysis_update_env_state(int n_rxn2, double *double_pointer_gpu, double *env_data, void *rxn_data)
{
  int n_rxn=n_rxn2;
  int *int_data = (int*) rxn_data;
...
__device__ void rxn_gpu_photolysis_calc_deriv_contrib(ModelDatagpu *model_data, double *state,
 ...
 */
#ifdef PMC_USE_SUNDIALS
__device__ void rxn_gpu_photolysis_calc_jac_contrib(ModelDatagpu *model_data, double *state, double *J,
