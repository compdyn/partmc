...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !> Read a single logical from a NetCDF file.
  subroutine pmc_nc_read_logical(ncid, var, name, must_be_present)
    ...
    call pmc_nc_check_msg(status, "inquiring variable " // trim(name))
    call pmc_nc_check_msg(nf90_get_var(ncid, varid, var_int), &
         "getting variable " // trim(name))

    var = var_int

  end subroutine pmc_nc_read_logical
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  !> Write a single logical to a NetCDF file as integer.
  subroutine pmc_nc_write_logical(ncid, var, name, unit, long_name, &
       standard_name, description)
    ...
    integer :: varid, dimids(0), var_int
    ...
    call pmc_nc_check(nf90_put_var(ncid, varid, var_int))

  end subroutine pmc_nc_write_logical
