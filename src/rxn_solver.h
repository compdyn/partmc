...
void * rxn_condensed_phase_arrhenius_calc_deriv_contrib(ModelData *model_data, realtype *deriv, void *rxn_data, double time_step);
void * rxn_condensed_phase_arrhenius_calc_jac_contrib(ModelData *model_data, realtype *J, void *rxn_data, double time_step);
