...
void * rxn_activity_calc_deriv_contrib(ModelData *model_data, realtype *deriv, void *rxn_data);
void * rxn_activity_calc_jac_contrib(ModelData *model_data, realtype *J, void *rxn_data);
