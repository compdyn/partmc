...
void * rxn_aqueous_equilibrium_update_env_state(
          double *rate_constants, ModelData *model_data, void *rxn_data);
...
realtype rxn_aqueous_equilibrium_calc_overall_rate(
          void *rxn_data, realtype *state, realtype react_fact,
          realtype prod_fact, realtype water, int i_phase);
void * rxn_aqueous_equilibrium_calc_deriv_contrib(
          double *rate_constants, ModelData *model_data,
          realtype *deriv, void *rxn_data, realtype time_step);
void * rxn_aqueous_equilibrium_calc_jac_contrib(
          double *rate_constants, ModelData *model_data,
          realtype *J, void *rxn_data, realtype time_step);
#endif
...
realtype rxn_HL_phase_transfer_calc_overall_rate(
          void *rxn_data, realtype *state, realtype cond_rc, realtype evap_rc,
          int i_phase);
