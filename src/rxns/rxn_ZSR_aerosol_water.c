...
void * rxn_ZSR_aerosol_water_calc_deriv_contrib(double *state, ModelData *model_data,
 ...
 */
#ifdef PMC_USE_SUNDIALS
void * rxn_ZSR_aerosol_water_calc_jac_contrib(double *state, ModelData *model_data,
