! Copyright (C) 2017-2021 Matt Dawson
! Licensed under the GNU General Public License version 2 or (at your
! option) any later version. See the file COPYING for details.

!> \file
!> The pmc_rxn_ternary_chemical_activation module.
...
module pmc_rxn_ternary_chemical_activation
...
end module pmc_rxn_ternary_chemical_activation
