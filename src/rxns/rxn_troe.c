 ...
 * \param rxn_float_data Pointer to the reaction floating-point data
 */
void rxn_troe_update_env_state(double *rate_constants, ModelData *model_data,
...
void rxn_troe_calc_deriv_contrib(double *rate_constants, ModelData *model_data,
 ...
 */
#ifdef PMC_USE_SUNDIALS
void rxn_troe_calc_jac_contrib(double *rate_constants, ModelData *model_data,
          realtype *J,
