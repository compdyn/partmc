...
if ! ../../numeric_diff --by elem --min-col 3 --max-col 4 --rel-tol 3 out/average_aero_particles_sorted.txt out/average_sizenum_aero_particles_sorted.txt &> /dev/null; then
