...
for i in range(len(times_sec)):
    ...
    g_num_lin.text(1.5,2.9,"0 h",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
    g_num_lin.text(2.5,1.1,"12 h",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
    g_num_lin.text(3,0.1,"24 h",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
	...
	styles = [graph.style.symbol(symbol = graph.style.symbol.circle,
				     size = 0.05,
				     symbolattrs = [color.grey.black])])
    g_vol_lin.text(2.3,1.1,"0 h",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
    g_vol_lin.text(2.8,2.2,"12 h",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
...
g_num_lin.writePDFfile("out/try1/brown_num_lin.pdf")
g_vol_lin.writePDFfile("out/try1/brown_vol_lin.pdf")
