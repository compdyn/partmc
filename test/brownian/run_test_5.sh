...
echo "../../numeric_average out/brownian_part_average_num_error.txt out/brownian_part_size_num_error_????.txt"
...
echo "../../numeric_diff out/brownian_part_size_num_average.txt out/brownian_sect_size_num.txt 0 0 0 0 2 0 >> out/brownian_part_average_num_error.txt"
