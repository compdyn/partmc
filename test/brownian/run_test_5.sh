...
echo "../../numeric_average out/brownian_mc_average_num_error.txt out/brownian_mc_size_num_error_????.txt"
...
echo "cat out/brownian_mc_average_num_error.txt"
cat out/brownian_mc_average_num_error.txt

echo "../../numeric_diff expected_error_num.txt out/brownian_mc_average_num_error.txt 0 1.0 1 1 2 0"
../../numeric_diff expected_error_num.txt out/brownian_mc_average_num_error.txt 0 1.0 1 1 2 0
status1=$?
echo "../../numeric_diff expected_error_num.txt out/brownian_mc_average_num_error.txt 0 1.0 2 2 2 0"
