...
! $Header: /project/work/rep/CCTM/src/chem/ebi_cb05cl_ae5/hrg4.F,v 1.1.1.1 2008/02/08 21:09:23 sjr Exp $ 

! what(1) key, module and SID; SCCS file; date and time of last delta:
! %W% %P% %G% %U%
!OJORBA3
       SUBROUTINE EXT_HRG4( DTC )
!OJORBA3
!**********************************************************************
!
!  FUNCTION:  To solve for the concentration of NO3 and N2O5
!
...
!..Production of NO3 (except from N2O5 )
      P15 =           RXRAT(   5 )      ! O+NO2=NO3
     &     +          RXRAT(   7 )      ! NO2+O3=NO3
     &     +          RXRAT(  29 )      ! OH+HNO3=NO3
     &     +  0.390 * RXRAT(  51 )      ! PNA=0.39*NO3+0.61*NO2+...

!..Loss frequency of NO3 ( except NO3 + NO3 if present )
...
!..Loss frequency of N2O5
      L16   =            RKI(  19 )                   ! N2O5=2*HNO3
     &        +          RKI(  20 )                   ! N2O5=2*HNO3
     &        +          RKI(  21 )                   ! N2O5=NO3+NO2
     &        +          RKI(  53 )                   ! N2O5=NO2+NO3

!..K15_15, R15_16, and R16_15 terms
      K15_15  = RKI(  50 ) * DTC
...
!..Solution of quadratic equation to get NO3 & N2O5
      CMN = 1.0 + L16 * DTC
      A = 2.0 * K15_15 * CMN
