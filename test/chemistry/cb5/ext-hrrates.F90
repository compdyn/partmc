...
! $Header: /project/work/rep/CCTM/src/chem/ebi_cb05cl_ae5/hrrates.F,v 1.1.1.1 2008/02/08 21:09:23 sjr Exp $ 

! what(1) key, module and SID; SCCS file; date and time of last delta:
! %W% %P% %G% %U%
!OJORBA3
      SUBROUTINE EXT_HRRATES
!OJORBA3
!***********************************************************************
!
!  FUNCTION: To calculate rates of reactions
!
...
!***********************************************************************
!..NOTE: RXRAT commented out are not referenced by any routine
...
!     RXRAT(  88 ) = RKI(  88 ) * YC( C2O3 ) * YC( NO2 )
      ...
      RXRAT( 178 ) = RKI( 178 ) * YC( TOLRO2 ) * YC( NO )
      RXRAT( 179 ) = RKI( 179 ) * YC( TOLRO2 ) * YC( HO2 )
      RXRAT( 180 ) = RKI( 180 ) * YC( XYLRO2 ) * YC( NO )
      RXRAT( 181 ) = RKI( 181 ) * YC( XYLRO2 ) * YC( HO2 )
      RXRAT( 182 ) = RKI( 182 ) * YC( BENZENE ) * YC( OH )
      RXRAT( 183 ) = RKI( 183 ) * YC( BENZRO2 ) * YC( NO )
      RXRAT( 184 ) = RKI( 184 ) * YC( BENZRO2 ) * YC( HO2 )
      RXRAT( 185 ) = RKI( 185 ) * YC( SESQ ) * YC( O3 )
      RXRAT( 186 ) = RKI( 186 ) * YC( SESQ ) * YC( OH )
      RXRAT( 187 ) = RKI( 187 ) * YC( SESQ ) * YC( NO3 )
