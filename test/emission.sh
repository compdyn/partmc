...
replot "out/emission_exact_summary_aero.d" index 0 using 1:2 w l title "Exact (0 mins)"
replot "out/emission_exact_summary_aero.d" index 5 using 1:2 w l title "Exact (5 mins)"
replot "out/emission_exact_summary_aero.d" index 10 using 1:2 w l title "Exact (10 mins)"
