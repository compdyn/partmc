...
plot "out/emission_part_size_num.txt" using 1:2 title "MC t = 0 hours"
replot "out/emission_part_size_num.txt" using 1:38 title "MC t = 12 hours"
replot "out/emission_part_size_num.txt" using 1:74 title "MC t = 24 hours"
