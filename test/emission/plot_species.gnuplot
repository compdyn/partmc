...
plot "out/emission_part_species.txt" using 1:2 title "MC initial"
replot "out/emission_part_species.txt" using 1:3 title "MC background"
replot "out/emission_part_species.txt" using 1:4 title "MC emission"
