...
echo "../../extract_aero_size_num 1e-8 1e-3 160 out/emission_mc_0001_ out/emission_mc_size_num.txt"
../../extract_aero_size_num 1e-8 1e-3 160 out/emission_mc_0001_ out/emission_mc_size_num.txt
