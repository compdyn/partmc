...
echo "../../extract_aero_size_mass 1e-8 1e-3 160 out/emission_part_0001_ out/emission_part_size_mass.txt"
...
echo "../../numeric_diff out/emission_part_size_mass.txt out/emission_exact_size_mass.txt 0 5e-2 0 0 2 0"
