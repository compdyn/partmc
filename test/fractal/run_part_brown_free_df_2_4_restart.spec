...
output_prefix out/restart_part_brown_free_df_2_4     # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart yes                     # whether to restart from saved state (yes/no)
restart_file out/part_brown_free_df_2_4_0001_00000021.nc # saved state file to restart from
