...
output_prefix out_dimless_t/restart/part_brown_free_df_2     # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart yes                     # whether to restart from saved state (yes/no)
restart_file out_dimless_t/part_brown_free_df_2_0001_00000021.nc # saved state file to restart from
