...
plot "out/golovin_part_size_num.txt" using 1:2 title "MC single t = 0 hours"
replot "out/golovin_part_size_num.txt" using 1:7 title "MC single t = 5 minutes"
replot "out/golovin_part_size_num.txt" using 1:12 title "MC single t = 10 minutes"
