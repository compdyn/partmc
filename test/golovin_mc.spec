...
output_file out/out_golovin_mc.d # name of output file
...
temp_profile golovin_temps.dat # temperature profile file
...
gas_init_conc golovin_gas_init.dat # initial gas concentrations
aerosol_data golovin_aerosol.dat # file containing aerosol data

n_init_dist 1                   # number of initial aerosol distributions

n_p 10000                       # number of particles
vol_frac golovin_vol_frac.dat # composition proportions of species
