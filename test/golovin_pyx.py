...
g.plot([data.file("out/golovin_exact_summary_num_avg.d", x = 2, y = 3,
		  title = "analyt"),
	data.file("out/golovin_exact_summary_num_avg.d", x = 2, y = 8, title = None),
	data.file("out/golovin_exact_summary_num_avg.d", x = 2, y = 13, title = None)],
       styles = [style.line(lineattrs=[pyx.style.linestyle.solid])])
g.plot([data.file("out/golovin_mc_summary_num_avg.d", x = 2, y = 3,
		  title = "MC"),
	data.file("out/golovin_mc_summary_num_avg.d", x = 2, y = 8, title = None),
	data.file("out/golovin_mc_summary_num_avg.d", x = 2, y = 13, title = None)],
...
g.plot([data.file("out/golovin_mc_summary_vol_avg.d", x = 2, y = 3,
		  title = "Monte Carlo (0 mins)"),
	data.file("out/golovin_mc_summary_vol_avg.d", x = 2, y = 8,
		  title = "Monte Carlo (5 mins)"),
	data.file("out/golovin_mc_summary_vol_avg.d", x = 2, y = 13,
		  title = "Monte Carlo (10 mins)")],
       styles = [style.symbol(size=0.1)])
g.plot([data.file("out/golovin_exact_summary_vol_avg.d", x = 2, y = 3,
		  title = "Analytical (0 mins)"),
	data.file("out/golovin_exact_summary_vol_avg.d", x = 2, y = 8,
		  title = "Analytical (5 mins)"),
	data.file("out/golovin_exact_summary_vol_avg.d", x = 2, y = 13,
