...
plot "out/loss_part_volume_0001_aero_size_num.txt" using 1:2 title "particle t = 0 hours", \
     ...
     "out/loss_exact_volume_aero_size_num.txt" using 1:2 with lines title "exact t = 0 hours", \
