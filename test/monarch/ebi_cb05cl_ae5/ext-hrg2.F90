...
! $Header: /project/work/rep/CCTM/src/chem/ebi_cb05cl_ae5/hrg2.F,v 1.1.1.1 2008/02/08 21:09:23 sjr Exp $ 

! what(1) key, module and SID; SCCS file; date and time of last delta:
! %W% %P% %G% %U%
!OJORBA3
      SUBROUTINE EXT_HRG2( DTC )
!OJORBA3
!**********************************************************************
!
!  FUNCTION: To solve for the concentration of HO, HO2, HONO, and
!            HNO4 alebraically.
!
...
!..stoichiometric coefficient for production of HOX from O3 via O1D
      O1D_S =            RKI(  10 )                   ! O1D=O
     &        +          RKI(  11 )                   ! O1D=2*OH
     &        +          RKI(  38 )                   ! O1D=OH+HO2
...
!..Production of HO from HO2 (r4,5 terms )
...
!..Production of HO from HONO (r4,19 terms )
      R4_19 =            RKI(  25 )                   ! HONO=OH+NO

      R4_19 = R4_19 * DTC

!..Remaining HO production
...
!..Production of HO2 from OH ( r5,4 terms )
...
!..Production of HO2 from HNO4 (r5,21 term )
      R5_21 =            RKI(  32 )                   ! PNA=HO2+NO2
     &        +  0.610 * RKI(  51 )                   ! PNA=0.61*HO2+...

      R5_21 = R5_21 * DTC

!..Remaining HO2 production terms
...
!..Production of HONO from OH (r19,4 terms )

      R19_4 =   RKI(  24 ) * YC( NO      ) * DTC      ! OH+NO=HONO

!..Remaining HONO production terms
      P19 =   2.000 * RXRAT(  23 )      ! NO+NO2=2*HONO

      P19 = YC0( HONO ) + P19 * DTC

!..Production of PNA from HO2 (r21,5 term )

      R21_5 =   RKI(  31 ) * YC( NO2     ) * DTC      ! HO2+NO2=HNO4

!..Remaining PNA production terms
      P21   =   YC0( PNA )

!..OH loss terms not in R5_4 & R19_4
...
!..HO2 loss terms not included in R4_5 & R21_5 (except for HO2+HO2 )
...
!..compute terms used to calculate a,b & c
      L21_INV = 1.0 / L21
...
!..compute remaining species concentrations
