...
replot "out/mosaic_summary_aero_total.d" using 1:5 with lines axes x1y2 title "aerosol NO3"
replot "out/mosaic_summary_aero_total.d" using 1:7 with lines axes x1y2 title "aerosol NH4"
