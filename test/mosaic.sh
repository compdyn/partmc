...
#plot "out/mosaic_summary_gas.d" using 1:5 with lines axes x1y1 title "gas NH3"
plot "out/mosaic_summary_aero_total.d" using 1:4 with lines axes x1y2 title "aerosol SO4"
