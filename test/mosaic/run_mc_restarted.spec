...
state_prefix out/mosaic_state_restarted # prefix of state files
...
t_state 2400                    # state output interval (0 disables) (s)
...
restart_name out/mosaic_state_0001_00000028.d # filename to restart from
