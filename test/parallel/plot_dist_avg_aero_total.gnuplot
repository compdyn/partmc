...
plot "out/sect_aero_time.txt" using ($1/3600):2 axes x1y1 with lines title "num sect", \
     "out/parallel_dist_aero_time.txt" using ($1/3600):2 axes x1y1 with lines title "num parallel", \
     ...
     "out/parallel_dist_aero_time.txt" using ($1/3600):3 axes x1y2 with lines title "mass parallel", \
