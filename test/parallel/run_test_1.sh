...
echo "om-mpirun -v -np 1 ../../partmc run_sect.spec"
om-mpirun -v -np 1 ../../partmc run_sect.spec
...
echo "om-mpirun -v -np 1 ../../partmc run_part_serial.spec"
om-mpirun -v -np 1 ../../partmc run_part_serial.spec
