...
plot "out/sedi_part_size_num.txt" using 1:2 title "MC single t = 0 hours"
replot "out/sedi_part_size_num.txt" using 1:3 title "MC single t = 5 minutes"
replot "out/sedi_part_size_num.txt" using 1:4 title "MC single t = 10 minutes"
