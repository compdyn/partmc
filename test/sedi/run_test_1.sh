...
echo "../../extract_aero_size_num 1e-8 1e-2 220 out/sedi_mc_0001_ out/sedi_mc_size_num.txt"
../../extract_aero_size_num 1e-8 1e-2 220 out/sedi_mc_0001_ out/sedi_mc_size_num.txt
