...
echo "../../numeric_diff out/sedi_part_size_num.txt out/sedi_sect_size_num.txt 0 5e-2 0 0 2 0"
../../numeric_diff out/sedi_part_size_num.txt out/sedi_sect_size_num.txt 0 5e-2 0 0 2 0
exit $?
