...
echo "../../extract_aero_size_mass 1e-8 1e-2 220 out/sedi_part_0001_ out/sedi_part_size_mass.txt"
...
echo "../../numeric_diff out/sedi_part_size_mass.txt out/sedi_sect_size_mass.txt 0 0.8 0 0 2 0"
