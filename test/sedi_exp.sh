...
plot [1e-7:1e-2] "out/sedi_exp_mc_summary_aero_binned.d" index 0 using 1:2 title "Monte Carlo (0 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 5 using 1:2 title "Monte Carlo (5 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 10 using 1:2 title "Monte Carlo (10 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 0 using 1:2 w l title "Sectional (0 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 5 using 1:2 w l title "Sectional (5 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 10 using 1:2 w l title "Sectional (10 mins)"
...
set ylabel "number density (#/m^3)"
set title "Sedimentation kernel, exponential initial condition"
plot [1e-7:1e-2] [1e2:1e10] "out/sedi_exp_mc_summary_aero_binned.d" index 0 using 1:2 title "Monte Carlo (0 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 5 using 1:2 title "Monte Carlo (5 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 10 using 1:2 title "Monte Carlo (10 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 0 using 1:2 w l title "Sectional (0 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 5 using 1:2 w l title "Sectional (5 mins)"
...
set title "Sedimentation kernel, exponential initial condition"
plot [1e-7:1e-2] [0:8e-6]  "out/sedi_exp_mc_summary_aero_binned.d" index 0 using 1:3 title "Monte Carlo (0 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 5 using 1:3 title "Monte Carlo (5 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 10 using 1:3 title "Monte Carlo (10 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 0 using 1:3 w l title "Sectional (0 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 5 using 1:3 w l title "Sectional (5 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 10 using 1:3 w l title "Sectional (10 mins)"
set terminal postscript eps
...
set ylabel "volume density (m^3/m^3)"
set title "Sedimentation kernel, exponential initial condition"
plot [1e-7:1e-2] [1e-20:1e3]  "out/sedi_exp_mc_summary_aero_binned.d" index 0 using 1:3 title "Monte Carlo (0 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 5 using 1:3 title "Monte Carlo (5 mins)"
replot "out/sedi_exp_mc_summary_aero_binned.d" index 10 using 1:3 title "Monte Carlo (10 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 0 using 1:3 w l title "Sectional (0 mins)"
replot "out/sedi_exp_sect_summary_aero_binned.d" index 5 using 1:3 w l title "Sectional (5 mins)"
