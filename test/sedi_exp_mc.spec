...
temp_profile test_sedi_exp_temps.dat # temperature profile file
...
gas_init_conc test_sedi_exp_gas_init.dat # initial gas concentrations
aerosol_data test_sedi_exp_aerosol.dat # file containing aerosol data

n_init_dist 1                   # number of initial distributions

n_p 10000000                    # number of particles
vol_frac test_sedi_exp_vol_frac.dat # composition proportions of species
