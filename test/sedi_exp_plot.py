...
g.plot([data.file("sedi_exp_mc_out_num_avg.d", x = 2, y = 3,
		  title = "Monte Carlo (0 mins)"),
	data.file("sedi_exp_mc_out_num_avg.d", x = 2, y = 8,
		  title = "Monte Carlo (5 mins)"),
	data.file("sedi_exp_mc_out_num_avg.d", x = 2, y = 13,
		  title = "Monte Carlo (10 mins)")],
       styles = [style.symbol(size=0.1)])
g.plot([data.file("sedi_exp_sect_out_num_avg.d", x = 2, y = 3,
		  title = "Sectional (0 mins)"),
	data.file("sedi_exp_sect_out_num_avg.d", x = 2, y = 8,
		  title = "Sectional (5 mins)"),
	data.file("sedi_exp_sect_out_num_avg.d", x = 2, y = 13,
		  title = "Sectional (10 mins)")],
       styles = [style.line()])
g.writeEPSfile("sedi_exp_pyx_num")
g.writePDFfile("sedi_exp_pyx_num")
...
g.plot([data.file("sedi_exp_sect_out_vol_avg.d", x = 2, y = 3,
		  title = "sect"),
	data.file("sedi_exp_sect_out_vol_avg.d", x = 2, y = 12,
		  title = None)],
       styles = [style.line([pyx.style.linestyle.solid])])
g.plot([data.file("sedi_exp_mc_out_vol_avg.d", x = 2, y = 3,
		  title = "MC"),
	data.file("sedi_exp_mc_out_vol_avg.d", x = 2, y = 12,
		  title = None)],
...
g.text(x, y, "9 mins")
g.writeEPSfile("sedi_exp_pyx_vol")
g.writePDFfile("sedi_exp_pyx_vol")
