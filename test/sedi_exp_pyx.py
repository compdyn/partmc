...
g.plot([data.file("out/sedi_exp_mc_summary_num_avg.d", x = 2, y = 3,
		  title = "Monte Carlo (0 mins)"),
	data.file("out/sedi_exp_mc_summary_num_avg.d", x = 2, y = 8,
		  title = "Monte Carlo (5 mins)"),
	data.file("out/sedi_exp_mc_summary_num_avg.d", x = 2, y = 13,
		  title = "Monte Carlo (10 mins)")],
       styles = [style.symbol(size=0.1)])
g.plot([data.file("out/sedi_exp_sect_summary_num_avg.d", x = 2, y = 3,
		  title = "Sectional (0 mins)"),
	data.file("out/sedi_exp_sect_summary_num_avg.d", x = 2, y = 8,
		  title = "Sectional (5 mins)"),
	data.file("out/sedi_exp_sect_summary_num_avg.d", x = 2, y = 13,
...
g.plot([data.file("out/sedi_exp_sect_summary_vol_avg.d", x = 2, y = 3,
		  title = "sect"),
	data.file("out/sedi_exp_sect_summary_vol_avg.d", x = 2, y = 12,
		  title = None)],
       styles = [style.line([pyx.style.linestyle.solid])])
g.plot([data.file("out/sedi_exp_mc_summary_vol_avg.d", x = 2, y = 3,
		  title = "MC"),
	data.file("out/sedi_exp_mc_summary_vol_avg.d", x = 2, y = 12,
		  title = None)],
