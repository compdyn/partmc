...
!> \file
!> The pmc_unit_test_rxn_CMAQ_OH_HNO3 module
module pmc_unit_test_rxn_CMAQ_OH_HNO3

  use pmc_camp_core!todo change unique state values temp and pressure
  use pmc_camp_state
  use pmc_mpi
  ...
  public :: unit_test_rxn_CMAQ_OH_HNO3_t
  ...
  !> The CMAQ_OH_HNO3 rxn unit test
  type, extends(unit_test_data_t) :: unit_test_rxn_CMAQ_OH_HNO3_t
    private
    !> Species ids
  ...
  end type unit_test_rxn_CMAQ_OH_HNO3_t

  !> Constructor for the CMAQ_OH_HNO3 test
  interface unit_test_rxn_CMAQ_OH_HNO3_t
    procedure :: constructor
  end interface unit_test_rxn_CMAQ_OH_HNO3_t

contains

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  !> Constructor for the CMAQ_OH_HNO3 unit test
  function constructor() result(new_obj)

    !> A new unit test object
    type(unit_test_rxn_CMAQ_OH_HNO3_t), pointer :: new_obj
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine initialize( this, camp_core )
    ...
    !> Unit test data
    class(unit_test_rxn_CMAQ_OH_HNO3_t), intent(inout) :: this
    !> CAMP core
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function input_file_name(this)
    ...
    !> Unit test data
    class(unit_test_rxn_CMAQ_OH_HNO3_t), intent(in) :: this

    input_file_name = "rxn_CMAQ_OH_HNO3_config.json"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function output_file_name(this)
    ...
    output_file_name = "rxn_CMAQ_OH_HNO3_results.txt"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function analyze_or_output(this, camp_core, camp_state, unique_state_id, &
    ...
    real(kind=dp) :: k1, k2, conv, air_conc, k_0, k_2, k_3, time
    ...
    k_0 = 1476.0d0 * exp(-398.0d0/temperature) * (temperature/300.0d0)**(60.0d0)
    k_2 = 1350.0d0 * exp(-450.0d0/temperature) * (temperature/300.0d0)**(58.0d0)
    k_3 = 4.0e-20 * exp(-2.0d0/temperature) * (temperature/300.0d0)**(1.5d0)
...
end module pmc_unit_test_rxn_CMAQ_OH_HNO3
