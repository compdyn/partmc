...
!> \file
!> The pmc_unit_test_rxn_emission module
module pmc_unit_test_rxn_emission
!TODO: Check multi-cell failing (update_rate_data)
  ...
  public :: unit_test_rxn_emission_t
  ...
  !> The emission rxn unit test
  type, extends(unit_test_data_t) :: unit_test_rxn_emission_t
    private
    !> Species ids
  ...
  end type unit_test_rxn_emission_t

  !> Constructor for the emission test
  interface unit_test_rxn_emission_t
    procedure :: constructor
  end interface unit_test_rxn_emission_t

contains

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  !> Constructor for the emission unit test
  function constructor() result(new_obj)

    !> A new unit test object
    type(unit_test_rxn_emission_t), pointer :: new_obj
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine initialize( this, camp_core )
    ...
    !> Unit test data
    class(unit_test_rxn_emission_t), intent(inout) :: this
    !> CAMP core
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function input_file_name(this)
    ...
    !> Unit test data
    class(unit_test_rxn_emission_t), intent(in) :: this

    input_file_name = "rxn_emission_config.json"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function output_file_name(this)
    ...
    output_file_name = "rxn_emission_results.txt"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  subroutine initialize_state(this, grid_cell_id, camp_core, camp_state, &
    ...
    call this%rate_update_B%set_rate(42.11d0)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  function analyze_or_output(this, camp_core, camp_state, unique_state_id, &
    ...
    true_conc( 1 ) = init_conc( 1 ) + (k1)*time
    true_conc( 2 ) = init_conc( 2 ) + (k2)*time
...
end module pmc_unit_test_rxn_emission
