...
!> \file
!> The pmc_unit_test_rxn_photolysis module
module pmc_unit_test_rxn_photolysis
  ...
  !> The photolysis rxn unit test
  type, extends(unit_test_data_t) :: unit_test_rxn_photolysis_t
    private
    !> Species ids
  ...
  end type unit_test_rxn_photolysis_t

  !> Constructor for the photolysis test
  interface unit_test_rxn_photolysis_t
    procedure :: constructor
  end interface unit_test_rxn_photolysis_t

contains

  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  !> Constructor for the photolysis unit test
  function constructor() result(new_obj)

    !> A new unit test object
    type(unit_test_rxn_photolysis_t), pointer :: new_obj
  ...
  subroutine initialize( this, camp_core )
    ...
    !> Unit test data
    class(unit_test_rxn_photolysis_t), intent(inout) :: this
    !> CAMP core
    ...
    ! Find the A photolysis reaction
    key = "photo id"
    i_mech_rxn_A = 0
    i_mech_rxn_B = 0
    ...
    call assert_msg( 883729398, this%idx_B.gt.0, "Missing species C" )
  ...
  function input_file_name(this)
    ...
    !> Unit test data
    class(unit_test_rxn_photolysis_t), intent(in) :: this

    input_file_name = "rxn_photolysis_config.json"
  ...
  function output_file_name(this)
    ...
    output_file_name = "rxn_photolysis_results.txt"
  ...
  subroutine initialize_state(this, grid_cell_id, camp_core, camp_state, &
    ...
    call this%rate_update_B%set_rate(924.9d0)
  ...
  function analyze_or_output(this, camp_core, camp_state, unique_state_id, &
    ...
    true_conc( 2 ) = init_conc( 1 ) * (k1/(k2-k1)) * &
...
end module pmc_unit_test_rxn_photolysis
