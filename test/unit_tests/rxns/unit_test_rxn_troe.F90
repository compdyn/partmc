...
!> \file
!> The pmc_unit_test_rxn_troe module
module pmc_unit_test_rxn_troe
  ...
  !> The troe rxn unit test
  type, extends(unit_test_data_t) :: unit_test_rxn_troe_t
    private
    !> Species ids
  ...
  end type unit_test_rxn_troe_t

  !> Constructor for the troe test
  interface unit_test_rxn_troe_t
    procedure :: constructor
  end interface unit_test_rxn_troe_t

contains

  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  !> Constructor for the troe unit test
  function constructor() result(new_obj)

    !> A new unit test object
    type(unit_test_rxn_troe_t), pointer :: new_obj
  ...
  subroutine initialize( this, camp_core )
    ...
    !> Unit test data
    class(unit_test_rxn_troe_t), intent(inout) :: this
    !> CAMP core
  ...
  function input_file_name(this)
    ...
    !> Unit test data
    class(unit_test_rxn_troe_t), intent(in) :: this

    input_file_name = "rxn_troe_config.json"
  ...
  function output_file_name(this)
    ...
    output_file_name = "rxn_troe_results.txt"
  ...
  function analyze_or_output(this, camp_core, camp_state, unique_state_id, &
    ...
    real(kind=dp) :: k1, k2, k_0, k_inf, conv, air_conc, time
    ...
    k_0 = air_conc * 1.2d-12 * exp( 3.0d0/temperature) * &
            (temperature/300.0d0)**(167.0d0) * conv
    k_inf = 136.0d0 * exp( 24.0d0/temperature) * (temperature/300.0d0)**(5.0d0)
    k_inf = k_0 / k_inf
...
end module pmc_unit_test_rxn_troe
