...
output_prefix out/weighting_nummass_specified # prefix of output files
n_repeat 1                      # number of Monte Carlo repeats
n_part 10000                    # total number of particles
restart no                      # whether to restart from saved state (yes/no)
do_select_weighting yes          # whether to select weighting explicitly (yes/no)
weight_type nummass_specified 
...
aerosol_init aero_init_dist_specified.dat # aerosol initial condition file
...
aero_emissions aero_emit_specified.dat    # aerosol emissions file
aero_background aero_back_specified.dat   # aerosol background file
