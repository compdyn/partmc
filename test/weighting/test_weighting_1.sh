...
../../extract_aero_size --num --dmin 1e-8 --dmax 1e-3 --nbin 160 out/weighting_0001
../../numeric_diff --by col --rel-tol 0.1 out/weighting_exact_aero_size_num.txt out/weighting_0001_aero_size_num.txt
