...
plot [1e-7:1e-3] [1e4:1e10] "out_golovin_mc_num_avg.d" using 2:3 title "Particle resolved (0 mins)"
replot "out_golovin_mc_num_avg.d" using 2:8 title "Particle resolved (5 mins)"
replot "out_golovin_mc_num_avg.d" using 2:13 title "Particle resolved (10 mins)"
...
set title "Golovin kernel, exponential initial condition"
set key left top
plot [1e-7:1e-3] [1e-14:1e-4] "out_golovin_mc_vol_avg.d" using 2:3 title "Particle resolved (0 mins)"
replot "out_golovin_mc_vol_avg.d" using 2:8 title "Particle resolved (5 mins)"
replot "out_golovin_mc_vol_avg.d" using 2:13 title "Particle resolved (10 mins)"
