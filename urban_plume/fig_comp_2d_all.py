...
label_point(g12, 0.06, 72, 0.6, 65, "D")
label_point(g12, 0.08, 50, 0.005, 70, "A")
label_point(g12, 0.06, 24, 0.008, 40, "E")
label_point(g12, 0.07, 14, 0.005, 18, "B")
label_point(g12, 0.2, 0, 0.6, 15, "C")

label_point(g21, 0.05, 87, 0.008, 72, "F")
label_point(g21, 0.07, 75, 0.6, 65, "D")
label_point(g21, 0.07, 31, 0.5, 45, "G")
label_point(g21, 0.1, 16, 0.005, 50, "A")
label_point(g21, 0.1, 5, 0.005, 18, "B")
label_point(g21, 0.2, 0, 0.6, 15, "C")

label_point(g22, 0.05, 87, 0.008, 72, "F")
label_point(g22, 0.09, 29, 0.5, 45, "G")
label_point(g22, 0.09, 14, 0.005, 50, "A")
label_point(g22, 0.12, 7, 0.005, 18, "B")
label_point(g22, 0.2, 0, 0.6, 15, "C")
