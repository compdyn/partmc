...
label_point(g11, 0.05, 100, 0.005, 70, "A,B")
label_point(g11, 0.2, 0, 0.6, 15, "C")

label_point(g12, 0.06, 84, 0.6, 65, "E")
label_point(g12, 0.06, 60, 0.005, 70, "A")
#label_point(g12, 0.06, 24, 0.008, 40, "D")
label_point(g12, 0.07, 30, 0.005, 18, "B")
label_point(g12, 0.2, 0, 0.6, 15, "C")

label_point(g21, 0.05, 100, 0.008, 72, "F,G")
#label_point(g21, 0.07, 75, 0.6, 65, "E")
#label_point(g21, 0.07, 31, 0.5, 45, "G")
label_point(g21, 0.1, 20, 0.005, 50, "A")
label_point(g21, 0.1, 7, 0.005, 18, "B")
label_point(g21, 0.2, 0, 0.6, 15, "C")

label_point(g22, 0.05, 100, 0.008, 72, "F,G")
#label_point(g22, 0.09, 29, 0.5, 45, "G")
label_point(g22, 0.09, 20, 0.005, 50, "A")
label_point(g22, 0.12, 10, 0.005, 18, "B")
