...
label_point(g11, 0.05, 100, 0.005, 70, "D1,G1")
label_point(g11, 0.2, 0, 0.6, 15, "N")

label_point(g12, 0.06, 84, 0.6, 65, "D2")
label_point(g12, 0.06, 60, 0.005, 70, "D1")
#label_point(g12, 0.06, 24, 0.008, 40, "D")
label_point(g12, 0.07, 30, 0.005, 18, "G1")
label_point(g12, 0.2, 0, 0.6, 15, "N")

label_point(g21, 0.05, 100, 0.008, 72, "D3,G3")
#label_point(g21, 0.07, 75, 0.6, 65, "E")
#label_point(g21, 0.07, 31, 0.5, 45, "G")
label_point(g21, 0.1, 20, 0.005, 50, "D1")
label_point(g21, 0.1, 7, 0.005, 18, "G1")
label_point(g21, 0.2, 0, 0.6, 15, "N")

label_point(g22, 0.05, 100, 0.008, 72, "D3,G3")
#label_point(g22, 0.09, 29, 0.5, 45, "G")
label_point(g22, 0.09, 20, 0.005, 50, "D1")
label_point(g22, 0.12, 10, 0.005, 18, "G1")
