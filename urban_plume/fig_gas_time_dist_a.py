...
g.text(1.5,3.5,"$O_3$",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
g.text(2,2.2,"$NO_2$",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
g.text(2.6,0.8,"HCHO",[text.halign.boxleft,text.valign.bottom,color.rgb(0,0,0)])
