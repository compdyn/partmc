...
plot "out/urban_plume_wc_aero_particle_mass_00000301.txt" using ($3*2e6):(($23/($4-$24))*100) with points notitle
set title "BC composition (with coag) at 7 hours"
plot "out/urban_plume_wc_aero_particle_mass_00000421.txt" using ($3*2e6):(($23/($4-$24))*100) with points notitle
set title "BC composition (with coag) at 24 hours"
plot "out/urban_plume_wc_aero_particle_mass_00001441.txt" using ($3*2e6):(($23/($4-$24))*100) with points notitle
