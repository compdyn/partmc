...
"out/urban_plume_summary_aero_binned.d" index 5 using 1:3 title "VL/SO4_a (index 5)" with lines, \
"out/urban_plume_summary_aero_binned.d" index 10 using 1:3 title "VL/SO4_a (index 10)" with lines
