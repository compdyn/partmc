...
plot [0:8] [0:001] "out/urban_plume_summary_aero_total.d" using (\$1/3600):43 with lines axes x1y2 title "aerosol SO4 "
...
replot "out/urban_plume_summary_aero_total.d" using (\$1/3600):46 with lines axes x1y2 title "aerosol NH4"
replot "out/urban_plume_summary_aero_total.d" using (\$1/3600):44 with lines axes x1y2 title "aerosol NO3"
#plot "out/urban_plume_summary_aero_total.d" using (\$1/3600):20 with lines axes x1y1 title "aerosol OC"
#replot "out/urban_plume_summary_aero_total.d" using (\$1/3600):21 with lines axes x1y2 title "aerosol BC"
#plot "out/urban_plume_summary_aero_total.d" using (\$1/3600):28 with lines axes x1y2 title "aerosol ARO1"
#replot "out/urban_plume_summary_aero_total.d" using (\$1/3600):29 with lines axes x1y2 title "aerosol ARO2"
